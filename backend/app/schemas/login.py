...
class InstructorCorreoRequest(BaseModel):
    """Solo correo: para iniciar el flujo de instructor."""
    correo: EmailStr


class InstructorCrearPasswordRequest(BaseModel):
    """Primer acceso: código OTP + nueva contraseña."""
    correo: EmailStr
    codigo: str
    nueva_contrasena: str
